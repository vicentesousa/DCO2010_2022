...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.aba.addTab(self.aba_widget_0, 'Sinal Original')
        ...
        self.aba.addTab(self.aba_widget_1, 'Sinal Filtrado (passa-baixa)')
        ...
        self.aba.addTab(self.aba_widget_2, 'Sinal Filtrado (passa-alta)')
        ...
        self.aba_grid_layout_0.addWidget(self._qtgui_time_sink_x_2_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.aba_grid_layout_0.setRowStretch(r, 1)
        for c in range(0, 1):
            self.aba_grid_layout_0.setColumnStretch(c, 1)
        ...
        self.aba_grid_layout_1.addWidget(self._qtgui_time_sink_x_1_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.aba_grid_layout_1.setRowStretch(r, 1)
        for c in range(0, 1):
            self.aba_grid_layout_1.setColumnStretch(c, 1)
        ...
        self.aba_grid_layout_2.addWidget(self._qtgui_time_sink_x_0_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.aba_grid_layout_2.setRowStretch(r, 1)
        for c in range(0, 1):
            self.aba_grid_layout_2.setColumnStretch(c, 1)
        ...
        self.qtgui_freq_sink_x_2.set_y_axis(-50, 10)
        ...
        self.aba_grid_layout_2.addWidget(self._qtgui_freq_sink_x_2_win, 1, 1, 1, 1)
        for r in range(1, 2):
            self.aba_grid_layout_2.setRowStretch(r, 1)
        for c in range(1, 2):
            self.aba_grid_layout_2.setColumnStretch(c, 1)
        ...
        self.qtgui_freq_sink_x_1.set_y_axis(-50, 10)
        ...
        self.aba_grid_layout_0.addWidget(self._qtgui_freq_sink_x_1_win, 1, 1, 1, 1)
        for r in range(1, 2):
            self.aba_grid_layout_0.setRowStretch(r, 1)
        for c in range(1, 2):
            self.aba_grid_layout_0.setColumnStretch(c, 1)
        ...
        self.qtgui_freq_sink_x_0.set_y_axis(-50, 10)
        ...
        self.aba_grid_layout_1.addWidget(self._qtgui_freq_sink_x_0_win, 1, 1, 1, 1)
        for r in range(1, 2):
            self.aba_grid_layout_1.setRowStretch(r, 1)
        for c in range(1, 2):
            self.aba_grid_layout_1.setColumnStretch(c, 1)
        self.interp_fir_filter_xxx_1 = filter.interp_fir_filter_ccc(1, [0.012135352939367294,0.02152285724878311,0.04717971757054329,0.0822787955403328,0.11742003262042999,0.14316627383232117,0.1525939404964447,0.14316627383232117,0.11742003262042999,0.0822787955403328,0.04717971757054329,0.02152285724878311,0.012135352939367294])
        self.interp_fir_filter_xxx_1.declare_sample_delay(0)
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_ccc(1, [-0.004691074136644602,-0.00882631167769432,0.10246928781270981,-0.27933958172798157,0.3760925829410553,-0.27933958172798157,0.10246928781270981,-0.00882631167769432,-0.004691074136644602])
        self.interp_fir_filter_xxx_0.declare_sample_delay(0)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 80000, 1, 0, 0)
        ...
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.qtgui_freq_sink_x_2, 0))
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.interp_fir_filter_xxx_1, 0), (self.qtgui_freq_sink_x_0, 0))
